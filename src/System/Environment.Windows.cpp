...
static constexpr auto UserRegistryKeyName = L"Environment";
static constexpr auto MachineRegistryKeyName = L"System\\CurrentControlSet\\Control\\Session Manager\\Environment";
...
TG_NOINLINE std::u16string Environment::StackTrace()
{
