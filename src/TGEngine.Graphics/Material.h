...
public:
    static std::optional<Material> Create(const char* vertexShaderCode, const char* fragmentShaderCode);
    static std::shared_ptr<Material> Create(const char* vertexShaderCode, const char* fragmentShaderCode, ReturnPointerTag);
    void Use();
    void Disuse();
