...
public:
    ...
    template <typename _Value, typename... Ts> requires(Arithmetic<_Value> && (Arithmetic<Ts> && ...))
    static constexpr _Value Min(const _Value& first, const _Value& second, const Ts&... args) noexcept;
    template <typename _Value> requires Arithmetic<_Value>
    static constexpr _Value Max(const _Value& first, const _Value& second) noexcept;
    template <typename _Value, typename... Ts> requires(Arithmetic<_Value> && (Arithmetic<Ts> && ...))
    static constexpr _Value Max(const _Value& first, const _Value& second, const Ts&... args) noexcept;
...
template <typename _Value, typename... Ts> requires(Arithmetic<_Value> && (Arithmetic<Ts> && ...))
constexpr _Value Mathf::Min(const _Value& first, const _Value& second, const Ts&... args) noexcept
{
...
template <typename _Value, typename... Ts> requires(Arithmetic<_Value> && (Arithmetic<Ts> && ...))
constexpr _Value Mathf::Max(const _Value& first, const _Value& second, const Ts&... args) noexcept
{
