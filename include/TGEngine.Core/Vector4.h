...
public:
    static constexpr _Value Dot(const BasicVector4& v1, const BasicVector4& v2) noexcept;
    constexpr _Value Dot(const BasicVector4& v) const noexcept;
    _Value& At(int32_t index);
    _Value At(int32_t index) const;
    static _Value Distance(const BasicVector4& v1, const BasicVector4& v2) noexcept;
    _Value Distance(const BasicVector4& v) const noexcept;
    _Value Length() const noexcept;
    _Value LengthSq() const noexcept;
    void Normalize();
    BasicVector4 Normalized() const;
...
BasicVector4(Ts...) -> BasicVector4<std::common_type_t<Ts...>>;
