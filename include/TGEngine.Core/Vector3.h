...
public:
    static constexpr BasicVector3 Reflect(const BasicVector3& inDirection, const BasicVector3& inPlaneNormal) noexcept;
    static constexpr _Value Dot(const BasicVector3& v1, const BasicVector3& v2) noexcept;
    constexpr _Value Dot(const BasicVector3& v) const noexcept;
    static constexpr BasicVector3 Cross(const BasicVector3& v1, const BasicVector3& v2) noexcept;
    ...
    static _Value Distance(const BasicVector3& v1, const BasicVector3& v2);
    _Value Distance(const BasicVector3& v) const noexcept;
    _Value Length() const;
    _Value LengthSq() const noexcept;
    void Normalize();
    BasicVector3 Normalized() const;
...
BasicVector3(Ts...) -> BasicVector3<std::common_type_t<Ts...>>;
