...
public:
    ...
    static constexpr Matrix3x4 Zero() noexcept;
    static constexpr Matrix3x4 Translate(float x, float y, float z) noexcept;
    static Matrix3x4 Rotate(float yaw, float pitch, float roll) noexcept;
    static Matrix3x4 RotateX(float radian) noexcept;
    static Matrix3x4 RotateY(float radian) noexcept;
    static Matrix3x4 RotateZ(float radian) noexcept;
    static constexpr  Matrix3x4 Scale(float x, float y, float z) noexcept;
    //static constexpr const Matrix4x3 Transposed(const Matrix3x4& matrix) noexcept;
    static constexpr Matrix3x4 Inverse();
