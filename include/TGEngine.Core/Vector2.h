...
public:
    static constexpr BasicVector2 Reflect(const BasicVector2& inDirection, const BasicVector2& inPlaneNormal) noexcept;
    static constexpr _Value Dot(const BasicVector2& v1, const BasicVector2& v2) noexcept;
    constexpr _Value Dot(const BasicVector2& v) const noexcept;
    static _Value Angle(const BasicVector2& v1, const BasicVector2& v2) noexcept;
    static _Value Distance(const BasicVector2& v1, const BasicVector2& v2) noexcept;
    _Value Distance(const BasicVector2& v) const noexcept;
    _Value& At(int32_t index);
    _Value At(int32_t index) const;
    _Value Length() const noexcept;
    _Value LengthSq() const noexcept;
    void Normalize();
    BasicVector2 Normalized() const;
...
template <typename... Ts> requires Arithmetic<Ts...>
BasicVector2(Ts...) -> BasicVector2<std::common_type_t<Ts...>>;
