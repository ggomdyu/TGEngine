...
public:
    ...
    static Matrix4x4 Translate(float x, float y, float z) noexcept;
    static Matrix4x4 Rotate(float yaw, float pitch, float roll) noexcept;
    static Matrix4x4 RotateX(float radian) noexcept;
    static Matrix4x4 RotateY(float radian) noexcept;
    static Matrix4x4 RotateZ(float radian) noexcept;
    static Matrix4x4 Scale(float x, float y, float z) noexcept;
    static Matrix4x4 Transposed(const Matrix4x4& matrix) noexcept;
    ...
    static Matrix4x4 OrthographicRH(float left, float right, float top, float bottom, float nearZ, float farZ) noexcept;
    static Matrix4x4 Viewport(float x, float y, float width, float height, float minZ, float maxZ) noexcept;
